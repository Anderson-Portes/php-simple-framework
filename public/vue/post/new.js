        ...
        <div class="card-body">
          ...
          <form @submit.prevent="handleSubmit">
            <div class="form-floating mb-2">
              <input class="form-control" id="title" placeholder="Title" v-model="post.title" required>
              <label for="title">Title</label>
            </div>
            <div class="form-floating mb-2">
              <textarea class="form-control" placeholder="Content" v-model="post.content" id="content" style="height: 150px;resize: none;" required></textarea>
